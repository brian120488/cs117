...
main(int argc, char *argv[]) {
    ...
    try {
        ...
        // Person result2 = findPerson(ps); 
        StructWithArrays swa[2] = {
                                {10,{ 
                                {"hey2", "e", 20}, 
                                {"hey2", "e", 20}, 
                                {"hey2", "e", 20}, {"hey2", "e", 20}, 
        ...
        StructWithArrays result = test(swa);
        // printf("Returned from findPerson(ps). Result=%s\n",result2.firstname.c_str());
        printf("Returned from test(swa). Result=%s\n",result.people[5].firstname.c_str());
    }
